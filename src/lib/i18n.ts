...
const MESSAGES: Record<Lang, Dict> = {
  ko: {
    ...
    'create.attachFile': '📎 카카오톡 대화 파일(.txt) 첨부',
    'create.attachHint': '카카오톡에서 내보낸 .txt 파일을 첨부하면 머리말을 빼고 최근 대화만 자동으로 채워요. 채운 뒤 직접 편집할 수 있어요.',
    'create.attachedInfo': '✅ 최근 {n}자를 사용했어요',
    'create.attachedInfoTrimmed': '✅ 원본 {total}자 중 최근 {n}자만 사용했어요',
  ...
  en: {
    ...
    'create.attachFile': '📎 Attach KakaoTalk chat file (.txt)',
    'create.attachHint': 'Attach a .txt exported from KakaoTalk — the header is stripped and the most recent conversation is filled in automatically. You can edit it afterward.',
    'create.attachedInfo': '✅ Using the latest {n} characters',
    'create.attachedInfoTrimmed': '✅ Using only the latest {n} of {total} characters',
